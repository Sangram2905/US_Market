...
class ML_Reg:
    ...
    def ml_regration_auto():
        ...
        for mlploop  in range(4):
            if mlploop == 0: # taking ML values for predicting nasdaq Resistance
            ...
            elif mlploop == 1:  # taking ML values for predicting nasdaq Support
            ...
            elif mlploop == 2: # taking ML values for predicting Dow  Resistance
            ...
            elif mlploop == 3:  # taking ML values for predicting Dow Support
